...
1:
    ...
    vfmv.v.f v9, ft1         # Broadcast weight[j] to all elements of v2
    ...
    vle32.v v5, (t1)         # Load 32-bit float into v5
    vle32.v v6, (t3)         # Load 32-bit float into v6
    vle32.v v7, (t4)         # Load 32-bit float into v7
    vle32.v v8, (t6)         # Load 32-bit float into v8

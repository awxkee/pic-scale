    ...
    while yy + 4 < destination.height {
        ...
        for x in 0..destination.width {
            ...
            while jx + 4 < bounds.size && x + 6 < destination.width {
                ...
                unsafe {
                    store_0 = convolve_horizontal_parts_4_sse_rgb(
                        bounds.start + jx,
                        unsafe_source_ptr_0,
                        weight0,
                        weight1,
                    ...
                    store_1 = convolve_horizontal_parts_4_sse_rgb(
                        bounds.start + jx,
                    ...
                    store_2 = convolve_horizontal_parts_4_sse_rgb(
                        bounds.start + jx,
                    ...
                    store_3 = convolve_horizontal_parts_4_sse_rgb(
                        bounds.start + jx,
    ...
    for _ in yy..destination.height {
        ...
        for x in 0..destination.width {
            ...
            while jx + 4 < bounds.size && x + 6 < destination.width {
                ...
                let weight3 = unsafe { ptr.add(3).read_unaligned() };
                unsafe {
                    store = convolve_horizontal_parts_4_sse_rgb(
                        bounds.start + jx,
                        unsafe_source_ptr_0,
                        weight0,
                        weight1,
            ...
            while jx + 2 < bounds.size && x + 3 < image_store.width {
                ...
                let weight1 = unsafe { ptr.add(1).read_unaligned() };
                unsafe {
                    store = convolve_horizontal_parts_two_sse_rgb(
                        bounds.start + jx,
                        unsafe_source_ptr_0,
                        weight0,
                        weight1,
